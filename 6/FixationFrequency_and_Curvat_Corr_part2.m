...
vidPath = 'G:\Projects\Vids\USC#01ST6.mp4';
...
for i = 1 : afN-6
  X = round(result_pairs(i, 2) * 30); % короткая сторона - СКО частоты
  Y = round(result_pairs(i, 3) * 3000); % длинная сторона - кривизна
