function test_metrics_gaze(S, mode)
...
featurePath = strcat('D:\Projects\USC#', S, '_encoded_0000.mp4+mv_features.csv');
...
if mode == 1
    writeLine(S, 'D:\Projects\Results\metrics-Gaze_M.csv');
else
    writeLine(S, 'D:\Projects\Results\metrics-Gaze_V.csv');
end
