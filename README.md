...
•	оперативная система Windows (64-bit) для использования UI (кроссплатформенно для бэкэнда); 
...
Главное меню программы выглядит следующим образом:  
 ...
 ![image](https://github.com/AI-group-72/FAEyeTON/assets/45206030/8e69694b-de93-442a-969d-99b12279bea2)
...
Рисунок 11. Уведомление об обучении модели 
...
Рисунок 12. Окно загрузи данных 

Загрузка 
На этапе загрузки данных открывается окно проводника, в котором нужно выбрать все файлы, которые необходимо проанализировать (см. рисунок 13). 

![image](https://github.com/AI-group-72/FAEyeTON/assets/45206030/3905117b-9bb8-43ba-b4ef-8aeb8fca7458)
 
Рисунок 13. Выбор данных для загрузки 

После загрузки данных будут происходить расчеты, после которых можно сохранить результаты. Для этого необходимо нажать на кнопку “Сохранить посчитанные данные” (см. рисунок 14).  
 
![image](https://github.com/AI-group-72/FAEyeTON/assets/45206030/d6dcdeb5-013f-478f-ad1f-0711f2b40a25)

 
Рисунок 14. Окно сохранения результатов расчета данных 
...
Разбиение данных 
На данном этапе загруженные в систему данные разбиваются для обучения. Предустановленный формат разбиения разделяет данные для обучения в соотношении 80% и 20% для обучения и контроля соответственно. Кнопка “Разбить выборку для обучения” позволяет разбивать выборку случайным образом (рисунок 15). 
 
![image](https://github.com/AI-group-72/FAEyeTON/assets/45206030/16e2bc82-620f-49c7-b067-611b22aadb5a)

 
Рисунок 15. Разбиение выборки для обучения 
Список характеристик 
Список характеристик состоит из 60 позиций, включающих в себя координаты, характеристики фиксаций, саккад, морганий и траектории. Кнопка “все” позволяет выбрать все возможные характеристики. Кнопка “стандарт” позволяет выбрать 7 лучших характеристик, выбранных на основе проведенного многоступенчатого анализа и экспертной оценки (см. раздел “Обучение нейросетей на собранных данных”). В окне справа можно выполнить поиск интересующей характеристики (см. рисунок 16). 
 
![image](https://github.com/AI-group-72/FAEyeTON/assets/45206030/9c757d3f-2c69-442d-9b4e-6e64da6a8da3)

 
Рисунок 16. Список доступных характеристик 
Виды алгоритмов 
...
Рисунок 17. Алгоритмы анализа данных 
...
Рисунок 18. Кнопки обучения, сохранения и загрузки модели 
...
Рисунок 19. Окно оценки точности 
Сохранение результатов 
После проведения всех расчетов окно программы выглядит следующим образом (см. рисунок 20). 
 

 ![image](https://github.com/AI-group-72/FAEyeTON/assets/45206030/4b91b458-d379-49e9-8772-711273681d96)
 
Рисунок 20. Главное меню программы после выполнения всех расчетов 
